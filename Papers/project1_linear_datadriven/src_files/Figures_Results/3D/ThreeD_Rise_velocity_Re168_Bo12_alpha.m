...
lgd1 = legend(legend_handles_1, legend_labels_1, ...
    'NumColumns', 1, 'Orientation', 'vertical', 'FontSize', lgdFontSize, ...
...
ax2_inset = axes('Parent', fig2, 'Position', [0.28 0.4 0.30 0.24]);
hold(ax2_inset, 'on');
box(ax2_inset, 'on');

h_DNS_m_inset = plot(ax2_inset, NaN, NaN, 'Color', col_DNS, 'LineStyle', ls_DNS, 'LineWidth', 3.5);
h_SLPOD_m_inset = plot(ax2_inset, NaN, NaN, 'Color', col_ME, 'LineStyle', ls_POD, 'LineWidth', 3.5);
h_SLDMD_m_inset = plot(ax2_inset, NaN, NaN, 'Color', col_ME, 'LineStyle', ls_DMD, 'LineWidth', 3.5);
uistack(h_DNS_m_inset, 'top');

xlim(ax2_inset, [0.5 2.5]);
ylim(ax2_inset, [0.6 0.75]);
set(ax2_inset, 'FontName', fontName, 'FontSize', 28, ...
...
print(fig1, fullfile(scriptDir, 'Figure7a2.eps'), '-depsc2', '-painters');
print(fig2, fullfile(scriptDir, 'Figure7b2.eps'), '-depsc2', '-painters');
...
fprintf('--- EPS export complete: Figure7a2-Figure7b2 ---\n');
